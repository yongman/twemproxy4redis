...
#define MSG_TYPE_CODEC(ACTION)                                                                      \
    ...
    ACTION( REQ_REDIS_SRANDMEMBER )            /* redis requests - set */                           \
    ...
    ACTION( REQ_REDIS_ZCARD )                  /* redis requests - sorted set */                    \
    ...
    ACTION( REQ_REDIS_LINSERT )                /* redis requests - list */                          \
